  ...
  useEffect(() => {
    ...
    const fetchRecipe = async () => {
      try {
        ...
        setInstructions(
          recipe.instructions || [{ subtitle: "", instruction: "" }]
        );
        Object.keys(nutritionRefs).forEach((key) => {
          if (nutritionRefs[key].current)
            nutritionRefs[key].current.value = recipe.nutrition?.[key] || "";
        });
      ...
      <div className="mt-53 mx-10 grid grid-cols-[1fr_9fr_1fr_1fr]">
        <div className="col-start-2 col-span-2">
          <div className="flex flex-row justify-between pb-9 border-b">
            <h1 className="text-6xl">Edit recipe</h1>

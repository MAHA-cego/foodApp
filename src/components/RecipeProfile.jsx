  ...
  return (
    ...
    >
      ...
      <div className="col-start-2 flex flex-col gap-8">
        ...
        <div
          className={`col-start-2 flex flex-row transition-opacity duration-300 text-xl underline gap-30 ${
            hovered ? "opacity-100" : "opacity-0"
          }`}
        >
          <button className="hover:cursor-pointer">Edit</button>
          <button className="text-darkGrey hover:cursor-pointer">Delete</button>
        </div>
      </div>
